class Cairo < Formula
  ...
  # See https://gitlab.freedesktop.org/cairo/cairo/issues/150
  patch do
    url "https://gitlab.freedesktop.org/suyuan/cairo/commit/416a0005ab6a2b9a709d05281025e3581d612989.diff"
    sha256 "f98616db83864d3eceb71e78189b3097c14053f286b7e29c14a14e86af41639d"
  end
